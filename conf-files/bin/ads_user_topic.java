...
//
// Debug information:
// Generated date: Fri Mar 12 01:28:55 CST 2021
...
public class ads_user_topic extends SqoopRecord  implements DBWritable, Writable {
  ...
  public ads_user_topic with_dt(java.sql.Date dt) {
    this.dt = dt;
    return this;
  }
  ...
  private Double day_users2users;
  public Double get_day_users2users() {
    return day_users2users;
  }
  public void set_day_users2users(Double day_users2users) {
    this.day_users2users = day_users2users;
  }
  public ads_user_topic with_day_users2users(Double day_users2users) {
    this.day_users2users = day_users2users;
    return this;
  }
  private Double payment_users2users;
  public Double get_payment_users2users() {
    return payment_users2users;
  }
  public void set_payment_users2users(Double payment_users2users) {
    this.payment_users2users = payment_users2users;
  }
  public ads_user_topic with_payment_users2users(Double payment_users2users) {
    this.payment_users2users = payment_users2users;
    return this;
  }
  private Double day_new_users2users;
  public Double get_day_new_users2users() {
    return day_new_users2users;
  }
  public void set_day_new_users2users(Double day_new_users2users) {
    this.day_new_users2users = day_new_users2users;
  }
  public ads_user_topic with_day_new_users2users(Double day_new_users2users) {
    this.day_new_users2users = day_new_users2users;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.day_users2users = JdbcWritableBridge.readDouble(7, __dbResults);
    this.payment_users2users = JdbcWritableBridge.readDouble(8, __dbResults);
    this.day_new_users2users = JdbcWritableBridge.readDouble(9, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeDouble(day_users2users, 7 + __off, 8, __dbStmt);
    JdbcWritableBridge.writeDouble(payment_users2users, 8 + __off, 8, __dbStmt);
    JdbcWritableBridge.writeDouble(day_new_users2users, 9 + __off, 8, __dbStmt);
    return 9;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.day_users2users = Double.valueOf(__dataIn.readDouble());
    }
    if (__dataIn.readBoolean()) { 
        this.payment_users2users = null;
    } else {
    this.payment_users2users = Double.valueOf(__dataIn.readDouble());
    }
    if (__dataIn.readBoolean()) { 
        this.day_new_users2users = null;
    } else {
    this.day_new_users2users = Double.valueOf(__dataIn.readDouble());
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.day_users2users) { 
        ...
        __dataOut.writeBoolean(false);
    __dataOut.writeDouble(this.day_users2users);
    }
    if (null == this.payment_users2users) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeDouble(this.payment_users2users);
    }
    if (null == this.day_new_users2users) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeDouble(this.day_new_users2users);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(day_users2users==null?"null":"" + day_users2users, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(payment_users2users==null?"null":"" + payment_users2users, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(day_new_users2users==null?"null":"" + day_new_users2users, delimiters));
    if (useRecordDelim) {
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("dt".equals(__fieldName)) {
      ...
      this.day_users2users = (Double) __fieldVal;
    }
    else    if ("payment_users2users".equals(__fieldName)) {
      this.payment_users2users = (Double) __fieldVal;
    }
    else    if ("day_new_users2users".equals(__fieldName)) {
      this.day_new_users2users = (Double) __fieldVal;
    }
    else {
